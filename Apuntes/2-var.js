...
var elementos = ["Computadora", "Celular"]; // Aquí la variable seleccionará
//toda una sección para los elementos del array, y después tendremos acceso
//a toda la sección destinada en memoria.
...
console.log(elementos[2]); // consola es de igual forma una variable que le
//pertenece al navegador, con cierto espacio en memoria, y con un tipo de
//comportamiento especial. Donde Log es un método de la función
